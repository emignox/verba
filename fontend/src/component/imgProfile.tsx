function imgProfile() {
  return (
    <div className="imgProfile">
      <img
        className=" lg:flex lg:flex-col  justify-center items-center mx-0 lg:w-28 lg:h-28 rounded-full  lg:my-10 "
        ...
        alt="imgProfile"
      />
      <h1 className="text-xl text-white text-center">Manu Poli </h1>
    </div>
  );
}
